import scrapy
from zoetermeerwijzer.items import ActiviteitenIZ
...
class IzIndewijkspiderSpider(scrapy.Spider):
    ...
    custom_settings = {
        ...
        'DOWNLOAD_DELAY': 2,  # Vertraag elke verzoek met 2 seconden
        'AUTOTHROTTLE_ENABLED': True,  # Activeer AutoThrottle om automatisch te vertragen
        'AUTOTHROTTLE_START_DELAY': 1,  # Start vertraging
        'AUTOTHROTTLE_MAX_DELAY': 10,  # Maximale vertraging
    }
    ...
    def parse(self, response):
        ...
        for activiteit in activiteiten:
            ...
            activiteit_iz['URL_plaatje'] = activiteit.css('div.UniversalListItem_imageContainer__TBU3s img::attr(src)').get()
